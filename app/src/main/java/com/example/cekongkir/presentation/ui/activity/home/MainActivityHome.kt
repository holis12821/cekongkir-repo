...
import com.example.cekongkir.databinding.HomeMainActivityBinding

class MainActivityHome : BaseActivity<HomeMainActivityBinding>() {

    override fun getResLayoutId(): Int = R.layout.home_main_activity
